...
from functions.ucs2 import Graph
...
# print(G['siwaka'])
# print(G['Sport_complex']['siwaka']['weight'])
node_pos = nx.get_node_attributes(G, 'pos')
routes_by_ucs = Graph()
routes_by_ucs.ucs(G, ['Sport-complex'], ['Parking_lot'])
print(routes_by_ucs.visited)
route_list = routes_by_ucs.visited
